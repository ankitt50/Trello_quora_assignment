...
public class AnswerService {
    ...
    public AnswerEntity createAnswer(
            AnswerEntity answerEntity, final String userName, final String questionId)
            throws AuthorizationFailedException, InvalidQuestionException {
        UserEntity userEntity = userDao.getUserByUsername(userName);
        UserAuthEntity userAuthEntity = userDao.saveLoginInfo();
        if (userEntity == null) {
    ...
    public AnswerEntity editAnswer(
        ...
        UserAuthEntity userAuthEntity = AuthTokenDao.checkAuthToken(accessToken);
